...
export const getLatestVersion = (projectId, modelId) => speckleFetch(streamVersionsQuery(projectId, modelId))

export const getModelObjects = (projectId, modelId, versionId) => speckleFetch(streamModelObjects(projectId, modelId, versionId))

export const getObjectData = (projectId, objectId) => speckleFetch(streamObjectData(projectId, objectId))
